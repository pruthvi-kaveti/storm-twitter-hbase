...
public class TwitterFunTopology {
    ...
    private static String consumerKey = "u6K1GrjlQn5HiuM8Z49D6VZmH";
    private static String consumerSecret = "3j8Yu7oC8qg0zrrjmUKIUmmoSvZc7ZqdZw1lukWZo4SsLySBVN";
    private static String accessToken = "579651015-qcLuK1AzmW5Biq4XpHbYrlSSBIPEZt0hfg7N9SPS";
    private static String accessTokenSecret = "GO1lx8GO4INU4vWYbALpGcRwAxCmbxeV5xe5DwVmDetcW";
    ...
    public static void main(String[] args) throws Exception {
        ...
        tweetFilterQuery.track(new String[]{"Modi"}); // OR on keywords
       /* tweetFilterQuery.locations(new double[][]{new double[]{-126.562500,30.448674},
        ...
        builder.setBolt("file-writer",fileWriterBolt,1).shuffleGrouping("spout");
